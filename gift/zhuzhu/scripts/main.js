;(function (window) {
  ...
  let texts = ['亲爱的猪猪', '我们认识', '已经' + DateMinus('2016-12-02').toString() + '天', '我们在一起', '已经' + DateMinus('2018-02-16').toString() + '天啦', '未来的日子', '手给你', '怀抱给你', '忐忑给你', '等待给你', '思念给你', '灵魂还有余生', '统统给你', '但你归我', '好不好', '爱你呀❤']
