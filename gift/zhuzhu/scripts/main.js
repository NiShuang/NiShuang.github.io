;(function (window) {
  ...
  let texts = ['亲爱的猪猪', '距第一次认识', DateMinus('2016-12-02').toString() + '天', '距第一次见面', DateMinus('2016-12-18').toString() + '天', '我们在一起', '已经' + DateMinus('2018-02-16').toString() + '天啦', '未来的日子', '手给你', '怀抱给你', '红豆给你', '灵魂还有余生', '统统给你', '但你要归我', '爱你猪猪❤', '你的爽爽']
